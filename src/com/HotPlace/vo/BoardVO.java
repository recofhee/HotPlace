...
public class BoardVO {
	...
	private int repcount;	// 리플수
	private Timestamp writedate;
	private String file_ori;
	private String file_modi;
	private int parent;
	private int indent;
	private int step;	//원글인지 답글인지 확인하는
	private int rec;	//답글끼리의 출력순서
	private int non_rec;
	...
	public String getFile_modi() {
		return file_modi;
	}

	public void setFile_modi(String file_modi) {
		this.file_modi = file_modi;
	}
